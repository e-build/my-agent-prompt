...
8. **구현 하위작업 이름 추출** — 화면 단위/공통 로직 단위로 동사형/명사형 작업명. 큰 작업은 API/Domain/Excel/Validation으로 분리, 테스트 작업 포함. 형식은 `references/examples.md §7`.
...
- [ ] 화면 단위/공통 로직 단위 하위작업 이름 + 테스트/회귀 작업 포함
