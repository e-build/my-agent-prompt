...
> **Related skill:** Run `/skill:super-brainstorming` first. Execute the plan task-by-task with `/skill:super-test-driven-development`.
...
**"Plan saved to `docs/plans/<filename>.md`. Implement it task-by-task with the test-driven-development skill."**
