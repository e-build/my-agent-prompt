...
> **Related skill:** Follow with `/skill:super-writing-plans` for implementation planning.
...
- Set up an isolated workspace — create a branch (or a git worktree) for larger work
- Use `/skill:super-writing-plans` to create detailed implementation plan
