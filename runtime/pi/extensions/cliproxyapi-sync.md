...
- 심링크 설치: `bash scripts/install-pi --restore` → `~/.pi/agent/extensions/cliproxyapi-sync.ts`
...
$NODE --test --experimental-strip-types runtime/pi/extensions/cliproxyapi-sync.test.ts
```
