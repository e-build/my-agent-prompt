...
```bash
ln -sfn "/Users/donggeollee/IdeaProjects/ebuild-github/my-agent-prompt/runtime/opencode/plugins/cliproxyapi-sync/cliproxyapi-sync.ts" "/Users/donggeollee/.config/opencode/plugins/cliproxyapi-sync.ts"
```
