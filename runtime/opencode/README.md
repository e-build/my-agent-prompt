...
```
runtime/opencode/plugins/<package-name>/
...
```bash
bash runtime/opencode/plugins/<package-name>/install-local.sh
bash runtime/opencode/plugins/<package-name>/install-local.sh --uninstall
```
...
- [ ] `runtime/opencode/plugins/<package-name>/` 디렉토리 생성
